  ...
  if (data.soilMoisture !== undefined) {
    if (data.soilMoisture < 15) {
      await createCriticalAlert(
        ...
        `Soil moisture at ${device.name} has dropped to ${data.soilMoisture}%. Immediate irrigation recommended.`,
      ...
      await createCriticalAlert(
        ...
        `Soil moisture at ${device.name} is at ${data.soilMoisture}%. Risk of waterlogging.`,
        { deviceId: device.id, soilMoisture: data.soilMoisture }
      );
    }
  }
